...
def parse_args():
    ...
    group.add_argument('--Bmap', '-b', type=str, default=None, help="B-map utilities for getting B statistics for specific sites in a VCF/txt file. Provide path to B map as following argument.")
    return parser
