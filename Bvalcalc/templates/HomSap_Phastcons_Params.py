...
f0 = 0.78 # Proportion of effectively neutral mutations with 0 <= |2Ns| < 1 (Note that 2Ns<5 does not contribute to BGS) [5]
f1 = 0.08 # Proportion of weakly deleterious mutations with 1 <= |2Ns| < 10 [5]
f2 = 0.08 # Proportion of moderately deleterious mutations with 10 <= |2Ns| < 100 [5]
