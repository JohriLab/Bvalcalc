...
f1 = 0.09 #(*Proportion of weakly deleterious mutations with 1 <= |2Nes| < 10 *) 0.6533 0.49
f2 = 0.04 #(*Proportion of moderately deleterious mutations with 10 <= |2Nes| < 100 *) 0.0533 0.04
f3 = 0.62 #(*Proportion of strongly deleterious mutations with |2Nes| >= 100 *) 0.2933 0.22
