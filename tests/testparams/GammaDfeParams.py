...
f0 = 0.07602 #(*Proportion of effectively neutral mutations with 0 <= |2Nes| < 1 *) 0.25
f1 = 0.09283 #(*Proportion of weakly deleterious mutations with 1 <= |2Nes| < 10 *) 0.6533 0.49
f2 = 0.20287 #(*Proportion of moderately deleterious mutations with 10 <= |2Nes| < 100 *) 0.0533 0.04
f3 = 0.62829 #(*Proportion of strongly deleterious mutations with |2Nes| >= 100 *) 0.2933 0.22
...
mean, shape, proportion_synonymous = 811/(2*Nanc), 0.347, 0 # Gamma distribution of DFE to discretize and replace f0-f3 [mean (2Ns), shape] (!Requires --gamma_dfe)