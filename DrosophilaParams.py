...
f0 = 0.25+0.16 # Proportion of effectively neutral mutations with 0 <= |2Ns| < 1 (Note that 2Ns<5 does not contribute to BGS)
f1 = 0.49-0.1 # Proportion of weakly deleterious mutations with 1 <= |2Ns| < 10
f2 = 0.04 # Proportion of moderately deleterious mutations with 10 <= |2Ns| < 100
f3 = 0.22-0.06 # Proportion of strongly deleterious mutations with |2Ns| >= 100
