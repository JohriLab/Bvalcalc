...
x = 1
g = 1*1e-8 #1e-8 #rate of gene conversion
tract_len=440 #mean tract length of gene conversion in base pairs
r = 1e-8*x #rate of recombination
...
f1 = 0.49 #(*Proportion of weakly deleterious mutations with 1 <= |2Nes| < 10 *) 0.6533
f2 = 0.04 #(*Proportion of moderately deleterious mutations with 10 <= |2Nes| < 100 *) 0.0533
f3 = 0.22 #(*Proportion of strongly deleterious mutations with |2Nes| >= 100 *) 0.2933
