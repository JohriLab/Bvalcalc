...
def calcBInGenes(chunk_size, num_chunks, precise_chunks, precise_blockstart, precise_blockend, chunk_start, chunk_end, rec_lengths, physical_lengths, precise_region_start, chunk_num, rec_rate_per_chunk):
